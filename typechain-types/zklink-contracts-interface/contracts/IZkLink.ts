...
export interface IZkLinkInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptERC20"
      | "acceptETH"
...
export interface IZkLink extends BaseContract {
  connect(runner?: ContractRunner | null): IZkLink;
  waitForDeployment(): Promise<this>;

  interface: IZkLinkInterface;
