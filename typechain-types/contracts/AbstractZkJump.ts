...
export interface AbstractZkJumpInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BROKER_ROLE"
...
export interface AbstractZkJump extends BaseContract {
  connect(runner?: ContractRunner | null): AbstractZkJump;
  waitForDeployment(): Promise<this>;

  interface: AbstractZkJumpInterface;
