...
export interface ZkJumpETHInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BROKER_ROLE"
...
export interface ZkJumpETH extends BaseContract {
  connect(runner?: ContractRunner | null): ZkJumpETH;
  waitForDeployment(): Promise<this>;

  interface: ZkJumpETHInterface;
